...
class BobCharacterOptions:
    ...
    def create_character(self, emitter, config_file):
        ...
        return nucypher.cli.actions.utils.make_cli_character(character_config=config,
                                                             emitter=emitter,
...
def destroy(general_config, config_options, config_file, force):
    ...
    # Request
    return nucypher.cli.actions.config.destroy_configuration(emitter, character_config=bob_config, force=force)
