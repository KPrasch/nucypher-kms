...
def test_ursula_rest_host_determination(click_runner):
    ...
    original_call = nucypher.cli.actions.config.get_external_ip_from_centralized_source
    original_save = UrsulaConfiguration.to_configuration_file

    try:
        nucypher.cli.actions.config.get_external_ip_from_centralized_source = lambda: '192.0.2.0'
        ...
        nucypher.cli.actions.config.get_external_ip_from_centralized_source = amazing_ip_oracle
        ...
        # Unpatch call
        nucypher.cli.actions.config.get_external_ip_from_centralized_source = original_call
